 ...
 *   <li>{@link fr.ffontenoy.e4.cheatsheet.model.cheatsheets.impl.DefaultItemImpl#getHeight <em>Height</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DefaultItemImpl extends MinimalEObjectImpl.Container implements Item {
	...
	public void setHeight(Integer newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CheatsheetsPackage.ITEM__HEIGHT, oldHeight, height));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CheatsheetsPackage.ITEM__HEIGHT:
				return getHeight();
		}
