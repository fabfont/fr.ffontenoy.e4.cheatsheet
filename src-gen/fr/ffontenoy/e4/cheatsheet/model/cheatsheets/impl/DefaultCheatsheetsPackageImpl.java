...
public class DefaultCheatsheetsPackageImpl extends EPackageImpl implements CheatsheetsPackage {
	 ...
	 * @generated
	 */
	public EAttribute getCommand_Required() {
	...
	public void createPackageContents() {
		...
		createEAttribute(commandEClass, COMMAND__REQUIRED);
	...
	public void initializePackageContents() {
		...
		initEReference(getItem_Command(), this.getCommand(), null, "command", null, 1, 1, Item.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(commandEClass, Command.class, "Command", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCommand_Required(), ecorePackage.getEBooleanObject(), "required", null, 0, 1, Command.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
